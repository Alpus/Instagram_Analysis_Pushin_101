...
profile_words = db.table('profile_words',
    ...
    get_like = db.Column(db.Integer, unsigned=True),
    get_comment = db.Column(db.Integer, unsigned=True),
    is_tag = db.Column(db.Boolean, unsigned=True, nullable=False))
...
class Posts(db.Model):
    ...
    id_post = db.Column(db.Integer, unsigned=True, nullable=False, primary_key=True)
...
class Filter(db.Model):
    ...
    id_filter = db.Column(db.Integer, unsigned=True, nullable=False, primary_key=True,
                        autoincrement=True)
...
usermarks = db.table('profile_usermarks',
    ...
    db.Column('id_post', db.Integer, db.ForeignKey('Posts.id_post'),
              unsigned=True, nullable=False),
    using_count = db.Column(db.Integer, unsigned=True),
    get_like = db.Column(db.Integer, unsigned=True),
    get_comment = db.Column(db.Integer, unsigned=True))